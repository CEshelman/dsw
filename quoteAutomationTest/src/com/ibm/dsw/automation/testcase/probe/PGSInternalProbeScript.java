 ...
 * @since 2013-1-28
 */
public class PGSInternalProbeScript extends BaseTestCase {

	public static WebdriverLogger loggerContxt =  WebdriverLogger.getLogger(PGSInternalProbeScript.class.getName());
	...
	public void assemblyBizFlow(){
		 ...
		 */
		PGSHomePage pgsHomePage = quoteFlow
		...
		partsAndPricingTab = quoteFlow.browseSoftwareParts(currentQuotePage);
...
//		loggerContxt.info("Search quote finished.....");
	...
	public static void main(String[] args) throws Exception {
		PGSInternalProbeScript test = new PGSInternalProbeScript();
		try{
			test.setScriptName("PGS Internal Probe Script Automation Test");
			test.setUp();
