 ...
 */
public class SQOOpenKenecaSubsumedPartDetails extends JSQOBasicTestCase {
    ...
    public void testOpenKenexaPartDetailsPage() {
        ...
        assertFalse(selenium.isTextPresent("Event Based Billing"));

        captureScreen("Subsumend Part: No Event Based Billing Option");
        driver.close();
