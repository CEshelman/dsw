...
public class PGSAddSaasPartToQuoteTest extends BaseTestCase {
	public static WebdriverLogger loggerContxt =  WebdriverLogger.getLogger(PGSAddSaasPartToQuoteTest.class.getSimpleName());
	...
	public void initTestData() {
		...
		if (prop == null) {
			prop = this
					.getTestDataProp("/com/ibm/dsw/automation/testcase/xprs/PGSAddSaasPartToQuoteTest.properties");
		}
	}
	...
	public void run() {
		...
		BrowseSoftwareAsServiceTabPage browseSoftwareAsServiceTabPage = browsePartsTabPage.browseSoftwareAsAServiceTabLinkClick();
		/*browseSoftwareAsServiceTabPage.configureSaas4CastIron();
		browseSoftwareAsServiceTabPage.addTheParts();*/
	...
	public static void main(String[] args) throws Exception {
		...
		PGSAddSaasPartToQuoteTest test = new PGSAddSaasPartToQuoteTest();
		test.initTestData();
		test.setUp();
		test.run();
		test.quitWebdriver();
