...
public class NativeExcelAdapterForSQ extends NativeExcelAdapter {
    
    public NativeExcelAdapterForSQ(){
        ...
        this.PART_COL_IND_BID_EXTENDED_PRICE_FORMULA = 25;
        this.PART_COL_IND_BP_DISCOUNT = 26;
        this.PART_COL_IND_BP_OVERRIDE_DISCOUNT = 27;
        this.PART_COL_IND_BP_EXTENDED_PRICE_FORMULA = 28;
        this.PART_COL_IND_TOTAL_LINE_DISCOUNT_FORMULA = 29;
        this.PART_COL_IND_BID_UNIT_PRICE_DECIMAL_4 = 30;
