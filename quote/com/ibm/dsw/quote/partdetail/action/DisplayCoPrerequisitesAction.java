 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DisplayCoPrerequisitesAction extends BaseContractActionHandler {
    ...
    public ResultBean executeBiz(ProcessContract contract, ResultHandler handler) throws QuoteException, ResultBeanException {
        ...
        try {
            ...
            details = process.getPartDetails(partNumber,quoteNum, "",true); 
    ...
    protected String getState(ProcessContract contract) {
        return PartDetailsStateKeys.STATE_DISPLAY_PART_COPREREQUISITES;
    }
}
