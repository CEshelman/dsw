...
public class EditOmittedPriorSSPriceAction extends PriorSSPriceAction {
	...
	public ResultBean executeBiz(ProcessContract contract, ResultHandler handler)
		...
		if (!validateInput(priorSSPriceContract, handler)) {
			...
			process.updateOmittedPriorSSPrice(priorSSPriceContract);
			...
			handler.addObject(DraftQuoteParamKeys.PARAM_WEB_QUOTE_YTY_FLAG,"true");
