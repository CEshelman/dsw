 ...
 * 
 * This <code>EditRQSalesTrackAction<code> class.
 *    
...
public class EditRQSalesTrackAction extends EditRQBaseAction {
    ...
    public int validate(User user, QuoteUserSession quoteUserSession, String renewalQuoteNum) throws QuoteException {
        ...
        return capabilityProcess.validateEditRQSalesTracking(user, quoteUserSession, renewalQuoteNum);
    }
    ...
    public String generateRedirectURL(ProcessContract baseContract) {
        return HtmlUtil.getURLForAction(DraftQuoteActionKeys.DISPLAY_SALES_INFO_TAB);
    }
