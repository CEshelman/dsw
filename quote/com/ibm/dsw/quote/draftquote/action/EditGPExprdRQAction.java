 ...
 * 
 * This <code>EditGPExprdRQAction<code> class.
 *    
...
public class EditGPExprdRQAction extends EditRQBaseAction {
    ...
    public int validate(User user, QuoteUserSession quoteUserSession, String renewalQuoteNum) throws QuoteException {
        ...
        return capabilityProcess.validateEditGPExprdRQ(user, quoteUserSession, renewalQuoteNum);
    }
    ...
    protected void populateQuote(EditRQContract editRQContract) throws QuoteException {
        ...
        quoteProcess.populateRenewalQuote(editRQContract.getUserId(), editRQContract.getRenewalQuoteNum(), true, editRQContract.getOrignFromCustChgReqFlag());
        
        //Call process to convert current draft renewal quote to sales quote
        quoteProcess.convertToSalsQuote(editRQContract.getUserId(), "", false);
    }
