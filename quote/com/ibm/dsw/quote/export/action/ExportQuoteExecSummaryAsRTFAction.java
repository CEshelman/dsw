 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ExportQuoteExecSummaryAsRTFAction extends ExportQuoteAction {
	...
	protected String export(ExportContract exportContract,
		...
		String exportedQuoteNum = eqProcess.exportQuoteExecSummaryAsRTF(bos, exportContract.getWebQuoteNum(), up2ReportingUserIds, exportContract.getUserId(), exportContract.getUser(), exportContract.getLocale(), exportContract.getTimeZone());
	...
	protected String getState(ProcessContract contract) {
		return ExportQuoteStateKeys.STATE_EXPORT_QUOTE_EXEC_SUMMARY_AS_RTF;
	}

    protected void addExtraParams(ResultHandler handler){
        handler.addObject(ExportQuoteParamKeys.PARAM_EXEC_SUMMARY_DOWNLOAD_FILE_EXT, QuoteConstants.FileExtension.RTF);
    }
}
