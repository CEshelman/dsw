...
import com.ibm.dsw.quote.base.cache.QuoteCacheableFactory;
 ...
 * @since EAD4J 3.4
 */
public class StatusSearchCacheableFactoryHelper {

    private static String cacheRegion = "QUOTE_CACHE_REGION";

    private static String cacheGroup = "STATUS_SEARCH_CACHE_GROUP";

    /** unique instance of this helper class */
    private static StatusSearchCacheableFactoryHelper singleton = new StatusSearchCacheableFactoryHelper();
     ...
     */
    public static StatusSearchCacheableFactoryHelper singleton() {
        return singleton;
    }
